          ...
          <div className="flex flex-col sm:flex-row items-center justify-between h-auto sm:h-16 py-4 sm:py-0 gap-4 sm:gap-0">
            ...
            <div className="flex flex-col xs:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
              <div className="flex items-center justify-center xs:justify-end gap-2 sm:gap-3 w-full sm:w-auto">
                <ConnectWallet className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-2 py-2 rounded-xl font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-200 flex items-center gap-2 w-full sm:w-auto justify-center" />
                <a
                  href="/upload"
